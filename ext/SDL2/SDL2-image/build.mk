...
LOCAL_MODULE := SDL2-image
EXTERNALS_PATH := ../SDL2-image-external

SUPPORT_JPG := true
JPG_LIBRARY_PATH := $(EXTERNALS_PATH)/jpeg-9

SUPPORT_PNG := true
PNG_LIBRARY_PATH := $(EXTERNALS_PATH)/libpng-1.6.2

SUPPORT_WEBP := false
WEBP_LIBRARY_PATH := $(EXTERNALS_PATH)/libwebp-0.3.0
