...
include $(PROJECT_PATH_BASE)/prebuilt-include/SDL2-core.mk
include $(PROJECT_PATH_BASE)/prebuilt-include/smpeg2.mk

LOCAL_MODULE := SDL2-mixer
EXTERNALS_PATH := ../SDL2-mixer-external

# Enable this if you want to support loading MOD music via modplug
# The library path should be a relative path to this directory.
SUPPORT_MOD_MODPLUG ?= true
MODPLUG_LIBRARY_PATH := $(EXTERNALS_PATH)/libmodplug-0.8.8.4

# Enable this if you want to support loading MOD music via mikmod
# The library path should be a relative path to this directory.
SUPPORT_MOD_MIKMOD ?= false
MIKMOD_LIBRARY_PATH := $(EXTERNALS_PATH)/libmikmod-3.1.12

# Enable this if you want to support loading MP3 music via SMPEG
# The library path should be a relative path to this directory.
SUPPORT_MP3_SMPEG ?= true
SMPEG_LIBRARY_PATH := $(EXTERNALS_PATH)/smpeg2-2.0.0

# Enable this if you want to support loading OGG Vorbis music via Tremor
# The library path should be a relative path to this directory.
SUPPORT_OGG ?= true
OGG_LIBRARY_PATH := $(EXTERNALS_PATH)/libogg-1.3.1
VORBIS_LIBRARY_PATH := $(EXTERNALS_PATH)/libvorbisidec-1.2.1


# Enable this if you want to support TiMidity
SUPPORT_TIMIDITY ?= false
TIMIDITY_LIBRARY_PATH := $(EXTERNALS_PATH)/timidity

LOCAL_C_INCLUDES := $(LOCAL_PATH)/include $(LOCAL_PATH)/../core/include
...
ifeq ($(SUPPORT_TIMIDITY),true)
	...
	LOCAL_SRC_FILES += $(wildcard $(LOCAL_PATH)/$(TIMIDITY_LIBRARY_PATH)/*.c)
endif
