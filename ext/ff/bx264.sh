...
build_arch i686    $NDK/platforms/android-18/arch-x86/     $NDK/toolchains/x86-4.9/prebuilt/linux-x86_64
build_arch x86_64  $NDK/platforms/android-21/arch-x86_64/  $NDK/toolchains/x86_64-4.9/prebuilt/linux-x86_64